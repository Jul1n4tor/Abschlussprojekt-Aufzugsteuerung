...
public class Main{
    public static void main(String[] args){
        ...
        /* Die unten gennante Methode versucht ein Grundnetz an Befehlen und Möglichkeiten für unser Programm aufzubauen. 
         * Diese Argumente können später auch auf die anderen Aufzüge angewendet werden. 
         * 
         * Ein Problem sehe ich noch in der if methode. Die Ergebnisse und eingaben spielen sich momentan noch lediglich in
         *  diesem Argument ab und geben nur aus was der user eingibt. Es geschieht keine intelligente verarbeitung der Inputs oder eine Abspeicherung
        */
        ...
        if (aufzugsNummer==2) {
            ...
            if (stockwerk < 100) {
            System.out.println ("Der Aufzug wird vom " + stockwerk + ". Stockwerk losfahren. Zu welchem Stockwerk soll der Aufzug fahren?");
            }
            else {
            ...
            if (stockwerk < 100) {
            System.out.println ("Sie haben den " + zielstockwerk + ". als Ziel-Stockwerk ausgewählt. Der Fahrstuhl wird vom "+stockwerk+". zum "+zielstockwerk+". fahren. Gute Fahrt!");
            }
            else {
            	System.out.println ("Das ist kein Stockwerk in diesem Haus!");
            	aufzugsNummer=0;
